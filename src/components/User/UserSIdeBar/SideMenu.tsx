  ...
  return (
    <div className='w-full ps-20 pe-8'>
        <div className='bg-white  mt-20  border rounded-md shadow-sm shadow-primary-400 overflow-hidden'>
            <div className={`${page==="dash"?'bg-primary-900 text-white':''} flex items-center gap-3 py-3 cursor-pointer px-6`}>
            ...
            <div className={`${page==="edit"?'bg-primary-900 text-white':''} flex items-center gap-3 py-3 cursor-pointer px-6`}>
